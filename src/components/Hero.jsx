    ...
    flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      items-center w-full'>
        ...
        ss:leading-[100px] leading-[75px]'>
          Your Trusted <br className='sm:block Your Trusted Surveillance Solution
          hidden'/>{" "}
          <span className='text-gradient'>Surveillance
          </span> {" "}
        </h1>
      ...
      mt-5`}>
      We assess CCTV systems based on key factors like 
      camera resolution, storage capacity, and 
      surveillance range to find the best fit for you.
      </p>
    </div>
